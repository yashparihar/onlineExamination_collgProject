<%-- 
    Document   : examinerHome
    Created on : 29 Mar, 2017, 1:36:24 PM
    Author     : Yash
--%>
...
<% 
     response.sendRedirect("examinerExamCatalog.jsp");
  ...
  //out.println("name: "+exauser.getExaminerid()+" and "+exauser.getExaminername());
