...
<form enctype="multipart/form-data" class="formoid-solid-orange" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Student Registration</h2></div>
	...
	<div class="element-input<?php frmd_add_class("input"); ?>"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="medium" type="text" name="input" required="required" placeholder="Roll No"/><span class="icon-place"></span></div></div>
	...
	<div class="element-radio<?php frmd_add_class("radio"); ?>"><label class="title">Gender<span class="required">*</span></label>		<div class="column column1"><label><input type="radio" name="radio" value="Femal" required="required"/><span>Femal</span></label><label><input type="radio" name="radio" value="Male" required="required"/><span>Male</span></label></div><span class="clearfix"></span>
</div>
	...
	<div class="element-multiple<?php frmd_add_class("multiple"); ?>"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><select data-no-selected="Nothing selected" name="multiple[]" multiple="multiple" required="required">
		...
		<option value="MBA">MBA</option></select><span class="icon-place"></span></div></div></div>
